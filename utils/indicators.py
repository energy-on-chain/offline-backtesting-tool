...
def roc(input_df, close_label, rolling_window):
    ...
    col_name = str(rolling_window) + '__ROC'
...
def sma(input_df, close_label, rolling_window):
    ...
    col_name = str(rolling_window) + '__sma'
...
def momentum(input_df, close_label, rolling_window):
    ...
    col_name = str(rolling_window) + '__momentum'
...
def chande_momentum_oscillator(input_df, close_label, rolling_window):
    ...
    col_name = str(rolling_window) + '__cmo'   
...
def garman_klass_volatility(input_df, open_label, high_label, low_label, close_label, rolling_window):
    ...
    col_name = str(rolling_window) + '__gkvolatility'   
...
if __name__ == '__main__':
    ...
    # print(df)
    df = pd.read_excel('/Users/hartimat/Desktop/indicator_qa/cmo_qa.xls', sheet_name='Input')
    result = chande_momentum_oscillator(df, 'Close', 5)
    print(result)
